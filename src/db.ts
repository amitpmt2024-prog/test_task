...
class DB {
  ...
  async initializeTables(): Promise<void> {
    try {
      ...
      `);
      console.log('[DB] ✓ items table created/verified');
      ...
      `);
      console.log('[DB] ✓ transactions table created/verified');

      // Create indexes for transactions (if they don't exist)
      await pool.query(`
      ...
      `);
      console.log('[DB] ✓ transaction indexes created/verified');
      ...
      `);
      console.log('[DB] ✓ sync_cursors table created/verified');
